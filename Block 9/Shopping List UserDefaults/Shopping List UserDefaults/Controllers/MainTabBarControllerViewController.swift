...
class MainTabBarControllerViewController: UITabBarController {
    ...
    func setupTabBar() {
        let itemsListController = createNavController(controller: ItemsListController(), itemName: "List", itemImage: "checklist")
        ...
        viewControllers = [itemsListController, savedListController]
    }
